...
impl SimpleComponent for SystemAboutPage {
    ...
    fn init(
            ...
            .or_else(|_| std::env::var("DESKTOP_SESSION"))
        {
            ...
            model.desktop_environment = session;
        }

        #[cfg(feature = "wgpu")]
        {
            model.graphics = Self::wgpu_graphics();
        }
